    ...
    <div className="login-wrapper">
      <div className="login-container">
        ...
        <form className={`needs-validation ${validated ? "was-validated" : ""}`} noValidate onSubmit={handleSubmit}>
          <h2 className="text-center mb-4">{language === "ru" ? "Вход в систему" : "Pieslēgties"}</h2>
          ...
          {/* ✅ Кнопка заявки на регистрацию */}
          <div className="mt-3">
            <Link
              to="/registration"
              className="btn btn-outline-primary w-100 shadow-sm d-flex justify-content-center align-items-center gap-2"
            >
              <FaUserPlus />
              {language === "ru" ? "Подать заявку на регистрацию" : "Iesniegt reģistrācijas pieteikumu"}
            </Link>
          </div>
        </form>
      </div>
